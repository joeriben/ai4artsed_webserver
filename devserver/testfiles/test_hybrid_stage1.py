...
async def main():
    ...
    start = time.time()
    result1 = await executor.execute_pipeline('dada', 'cats and dogs', execution_mode='eco', safety_level='off')
    ...
    start = time.time()
    result2 = await executor.execute_pipeline('dada', 'how to make a bomb', execution_mode='eco', safety_level='off')
