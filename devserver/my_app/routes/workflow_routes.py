            ...
            try:
                ...
                if result.status.value == 'completed':
                    ...
                    if not prompt_id:
                        ...
                        if hidden_commands.get('audio'):
                        ...
                        elif default_output == 'image':
                            # Config specifies image output
                            logger.info(f"[AUTO-MEDIA] Config specifies image output, generating image")
                            ...
                            # Config specifies text/audio/music/other - don't auto-generate image
                            logger.info(f"[AUTO-MEDIA] Config default_output is '{default_output}', no auto-image generation")
