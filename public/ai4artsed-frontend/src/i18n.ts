...
const messages = {
  de: {
    ...
    surrealizer: {
      ...
      sliderHint: 'α<0: CLIP-L verstärkt, T5 invertiert | α=0: reines CLIP-L (visuell) | α=1: reines T5-XXL (sprachlich) | α>1: Extrapolation über T5 hinaus | Formel: (1-α)·CLIP-L + α·T5',
  ...
  en: {
    ...
    surrealizer: {
      ...
      sliderExtremeWeird: 'super weird',
      sliderExtremeCrazy: 'super crazy',
      sliderHint: 'α<0: CLIP-L amplified, T5 inverted | α=0: pure CLIP-L (visual) | α=1: pure T5-XXL (linguistic) | α>1: extrapolation past T5 | formula: (1-α)·CLIP-L + α·T5',
