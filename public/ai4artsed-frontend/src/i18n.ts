  ...
  de: {
    ...
    latentLab: {
      ...
      probing: {
        ...
        addRange: 'Zweiten Bereich hinzufügen',
        selectionDesc: '{count} Dimensionen von Prompt B ausgewählt (Rang {from}–{to} von {total})',
  ...
  en: {
    ...
    latentLab: {
      ...
      probing: {
        ...
        range1Label: 'Range 1',
        range2Label: 'Range 2',
        addRange: 'Add second range',
        selectionDesc: '{count} dimensions from Prompt B selected (rank {from}–{to} of {total})',
