  ...
  de: {
    ...
    latentLab: {
      ...
      probing: {
        ...
        explainHowText: 'Im Balkendiagramm siehst du die Dimensionen mit dem größten Unterschied. Wähle über den Schwellenwert-Regler oder manuell per Checkbox, welche du übertragen willst. Beim Klick auf „Übertragen" wird das Bild mit denselben Einstellungen (gleicher Seed!) neu generiert — aber mit den ausgewählten Dimensionen aus Prompt B. So siehst du exakt, was diese Dimensionen „kodieren".',
        ...
        transferBtn: 'Übertragen + Erzeugen',
        transferring: 'Bild mit modifiziertem Embedding wird erzeugt...',
        thresholdLabel: 'Schwellenwert',
        thresholdHint: 'Alle Dimensionen mit einer Differenz über diesem Wert werden zur Übertragung ausgewählt. Schiebe den Regler, um mehr oder weniger Dimensionen einzuschließen.',
        dimLabel: 'Dimension',
        dimDiff: 'Differenz',
        dimHint: 'Aktiviere einzelne Dimensionen manuell oder nutze den Schwellenwert-Regler.',
        originalLabel: 'Original (Prompt A)',
        modifiedLabel: 'Modifiziert (Transfer)',
        modifiedHint: 'Wähle unten Dimensionen aus und klicke „Übertragen" — hier erscheint dann Prompt A mit den übertragenen Dimensionen aus B (gleicher Seed).',
        noDifference: 'Die Embeddings sind identisch — ändere Prompt B.',
        emptyHint: 'Gib zwei Prompts ein und klicke auf Analysieren, um die Embedding-Differenz zu visualisieren.',
        advancedLabel: 'Erweiterte Einstellungen',
        negativeLabel: 'Negativ-Prompt',
        stepsLabel: 'Steps',
        cfgLabel: 'CFG',
        seedLabel: 'Seed',
        selectedDims: 'ausgewählt',
        selectAll: 'Alle',
        selectNone: 'Keine'
      }
    },
  ...
  en: {
    ...
    latentLab: {
      ...
      probing: {
        ...
        explainHowText: 'The bar chart shows dimensions with the largest difference. Use the threshold slider or manual checkboxes to select which to transfer. Clicking "Transfer" regenerates the image with the same settings (same seed!) — but with selected dimensions from prompt B. This lets you see exactly what those dimensions "encode".',
        ...
        transferBtn: 'Transfer + Generate',
        transferring: 'Generating image with modified embedding...',
        thresholdLabel: 'Threshold',
        thresholdHint: 'All dimensions with a difference above this value are selected for transfer. Slide to include more or fewer dimensions.',
        dimLabel: 'Dimension',
        dimDiff: 'Difference',
        dimHint: 'Activate individual dimensions manually or use the threshold slider.',
        originalLabel: 'Original (Prompt A)',
        modifiedLabel: 'Modified (Transfer)',
        modifiedHint: 'Select dimensions below and click "Transfer" — this will show prompt A with the transferred dimensions from B (same seed).',
        noDifference: 'The embeddings are identical — change prompt B.',
        emptyHint: 'Enter two prompts and click Analyze to visualize the embedding difference.',
        advancedLabel: 'Advanced Settings',
        negativeLabel: 'Negative Prompt',
        stepsLabel: 'Steps',
        cfgLabel: 'CFG',
        seedLabel: 'Seed',
        selectedDims: 'selected',
        selectAll: 'All',
        selectNone: 'None'
      }
    },
