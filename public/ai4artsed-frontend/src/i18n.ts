  ...
  de: {
    ...
    latentLab: {
      ...
      textLab: {
        ...
        explainWhatTitle: 'Was zeigt dieses Tool?',
        explainWhatText: 'Dieses Tool implementiert drei aktuelle Forschungsans\u00e4tze zur LLM-Interpretierbarkeit: Representation Engineering (Zou et al. 2023) findet Konzept-Richtungen im Aktivierungsraum und manipuliert Modellverhalten gezielt. Vergleichende Modell-Arch\u00e4ologie (Belinkov 2022, Olsson 2022) zeigt, wie verschiedene Modelle denselben Text intern repr\u00e4sentieren. Bias-Arch\u00e4ologie (Zou 2023, Bricken 2023) deckt systematische Verzerrungen durch kontrollierte Token-Manipulation auf. — Refs: Zou et al. (arXiv:2310.01405), Li et al. (arXiv:2306.03341), Belinkov (DOI:10.1162/coli_a_00422), Olsson et al. (arXiv:2209.11895), Bricken et al. (transformer-circuits.pub/2023/monosemantic-features)',
        explainHowTitle: 'Wie benutze ich das Tool?',
        explainHowText: 'Wähle oben ein Modell-Preset aus dem Dropdown (Standard: small / Llama 3.2 3B). Das Modell wird automatisch geladen, wenn du ein Experiment startest. Drei Tabs stehen zur Verfügung: Tab 1 (RepEng) definiert Kontrastpaare und findet Konzept-Richtungen. Tab 2 (Vergleich) vergleicht zwei Modelle und ihre inneren Repräsentationen. Tab 3 (Bias) führt systematische Bias-Experimente durch.',
        modelPanel: {
          presetLabel: 'Preset',
  ...
  en: {
    ...
    latentLab: {
      ...
      textLab: {
        ...
        explainWhatTitle: 'What does this tool show?',
        explainWhatText: 'This tool implements three current research approaches to LLM interpretability: Representation Engineering (Zou et al. 2023) finds concept directions in activation space and manipulates model behavior in a targeted way. Comparative Model Archaeology (Belinkov 2022, Olsson 2022) shows how different models internally represent the same text. Bias Archaeology (Zou 2023, Bricken 2023) uncovers systematic biases through controlled token manipulation. — Refs: Zou et al. (arXiv:2310.01405), Li et al. (arXiv:2306.03341), Belinkov (DOI:10.1162/coli_a_00422), Olsson et al. (arXiv:2209.11895), Bricken et al. (transformer-circuits.pub/2023/monosemantic-features)',
        explainHowTitle: 'How do I use this tool?',
        explainHowText: 'Choose a model preset from the dropdown above (default: small / Llama 3.2 3B). The model loads automatically when you run an experiment. Three tabs are available: Tab 1 (RepEng) defines contrast pairs and finds concept directions. Tab 2 (Compare) compares two models and their internal representations. Tab 3 (Bias) runs systematic bias experiments.',
        modelPanel: {
          presetLabel: 'Preset',
        ...
        compare: {
          ...
          science: 'Based on Belinkov (2022) "Probing Classifiers" and Olsson et al. (2022) "In-Context Learning and Induction Heads". The heatmap shows CKA (Centered Kernel Alignment) between layers of both models. High similarity means: these layers represent information in a similar way. Early layers (syntax) are often similar \u2014 late layers (semantics) diverge more strongly, especially with different model sizes. — Refs: Belinkov (DOI:10.1162/coli_a_00422), Olsson et al. (arXiv:2209.11895)',
  ...
  tr: {
    ...
    latentLab: {
      ...
      textLab: {
        ...
        explainWhatTitle: 'Bu araç ne gösteriyor?',
        explainWhatText: 'Bu araç, LLM yorumlanabilirliğine yönelik üç güncel araştırma yaklaşımını hayata geçirir: Temsil Mühendisliği (Zou vd. 2023), aktivasyon uzayında kavram yönleri bulur ve model davranışını hedefli olarak manipüle eder. Karşılaştırmalı Model Arkeolojisi (Belinkov 2022, Olsson 2022), farklı modellerin aynı metni nasıl temsil ettiğini gösterir. Önyargı Arkeolojisi (Zou 2023, Bricken 2023), kontrollü token manipülasyonu aracılığıyla sistematik önyargıları ortaya çıkarır. — Refs: Zou et al. (arXiv:2310.01405), Li et al. (arXiv:2306.03341), Belinkov (DOI:10.1162/coli_a_00422), Olsson et al. (arXiv:2209.11895), Bricken et al. (transformer-circuits.pub/2023/monosemantic-features)',
        explainHowTitle: 'Bu aracı nasıl kullanırım?',
        explainHowText: 'Yukarıdaki açılır menüden bir model hazır ayarı seçin (varsayılan: small / Llama 3.2 3B). Model, bir deney çalıştırdığınızda otomatik olarak yüklenir. Üç sekme mevcuttur: Sekme 1 (RepEng) kontrast çiftleri tanımlar ve kavram yönleri bulur. Sekme 2 (Karşılaştır) iki modeli ve iç temsillerini karşılaştırır. Sekme 3 (Önyargı) sistematik önyargı deneyleri yürütür.',
        modelPanel: {
        ...
        bias: {
          ...
          science: 'Zou vd. (2023) "Representation Engineering" ve Bricken vd. (2023) "Towards Monosemanticity" çalışmalarına dayanır. Serbest manipülasyon yerine bu araç sistematik önyargıları araştırır: Tüm eril zamirler bastırıldığında ne olur? Model varsayılan olarak hangi cinsiyeti seçer? Pozitif ve negatif kelimeler güçlendirildiğinde metin ne kadar güçlü değişir? Cevaplar, hangi önyargıların modele kodlandığını ortaya koyar. — Refs: Zou et al. (arXiv:2310.01405), Bricken et al. (transformer-circuits.pub/2023/monosemantic-features)',
  ...
  ko: {
    ...
    latentLab: {
      ...
      textLab: {
        ...
        explainWhatTitle: '이 도구는 무엇을 보여주나요?',
        explainWhatText: '이 도구는 LLM 해석 가능성에 대한 세 가지 현재 연구 접근법을 구현합니다: Representation Engineering (Zou et al. 2023)은 활성화 공간에서 개념 방향을 찾고 모델 동작을 목표적으로 조작합니다. — Refs: Zou et al. (arXiv:2310.01405), Li et al. (arXiv:2306.03341), Belinkov (DOI:10.1162/coli_a_00422), Olsson et al. (arXiv:2209.11895), Bricken et al. (transformer-circuits.pub/2023/monosemantic-features)',
        explainHowTitle: '이 도구를 어떻게 사용하나요?',
        explainHowText: '위의 드롭다운에서 모델 프리셋을 선택하세요 (기본: small / Llama 3.2 3B). 실험을 실행하면 모델이 자동으로 로드됩니다. 세 개의 탭을 사용할 수 있습니다: 탭 1(RepEng)은 대조 쌍을 정의하고 개념 방향을 찾습니다. 탭 2(비교)는 두 모델과 내부 표현을 비교합니다. 탭 3(바이어스)는 체계적인 바이어스 실험을 수행합니다.',
        modelPanel: {
          presetLabel: '프리셋',
        ...
        repeng: {
          ...
          science: 'Zou et al. (2023) "Representation Engineering" 및 Li et al. (2024) "Inference-Time Intervention"에 기반합니다. — Refs: Zou et al. (arXiv:2310.01405), Li et al. (arXiv:2306.03341)',
          pairsTitle: '대조 쌍',
        ...
        compare: {
          ...
          science: 'Belinkov (2022) "Probing Classifiers" 및 Olsson et al. (2022)에 기반합니다. 히트맵은 두 모델의 레이어 간 CKA를 보여줍니다. — Refs: Belinkov (DOI:10.1162/coli_a_00422), Olsson et al. (arXiv:2209.11895)',
        ...
        bias: {
          ...
          science: 'Zou et al. (2023) 및 Bricken et al. (2023)에 기반합니다. 이 도구는 체계적 바이어스를 조사합니다: 모든 남성 대명사가 억제되면 어떻게 되나요? — Refs: Zou et al. (arXiv:2310.01405), Bricken et al. (transformer-circuits.pub/2023/monosemantic-features)',
          presetLabel: '실험 유형',
  ...
  uk: {
    ...
    latentLab: {
      ...
      textLab: {
        ...
        explainWhatTitle: 'Що показує цей інструмент?',
        explainWhatText: 'Цей інструмент реалізує три сучасні дослідницькі підходи до інтерпретованості LLM: Representation Engineering (Zou та ін. 2023) знаходить напрямки концептів у просторі активацій та цілеспрямовано маніпулює поведінкою моделі. — Refs: Zou et al. (arXiv:2310.01405), Li et al. (arXiv:2306.03341), Belinkov (DOI:10.1162/coli_a_00422), Olsson et al. (arXiv:2209.11895), Bricken et al. (transformer-circuits.pub/2023/monosemantic-features)',
        explainHowTitle: 'Як користуватися цим інструментом?',
        explainHowText: 'Оберіть набір моделі з випадного меню вгорі (за замовчуванням: small / Llama 3.2 3B). Модель завантажується автоматично при запуску експерименту. Доступні три вкладки: Вкладка 1 (RepEng) визначає контрастні пари та знаходить напрямки концептів. Вкладка 2 (Порівняння) порівнює дві моделі та їх внутрішні представлення. Вкладка 3 (Упередженість) запускає систематичні експерименти з упередженістю.',
        modelPanel: {
          presetLabel: 'Набір',
        ...
        repeng: {
          ...
          science: 'На основі Zou та ін. (2023) «Representation Engineering» та Li та ін. (2024) «Inference-Time Intervention». Основна ідея: LLM кодують абстрактні концепти (істина, сентимент, етика) як напрямки у високовимірному просторі активацій. — Refs: Zou et al. (arXiv:2310.01405), Li et al. (arXiv:2306.03341)',
        ...
        compare: {
          ...
          science: 'На основі Belinkov (2022) «Probing Classifiers» та Olsson та ін. (2022) «In-Context Learning and Induction Heads». Теплова карта показує CKA (Centered Kernel Alignment) між шарами обох моделей. — Refs: Belinkov (DOI:10.1162/coli_a_00422), Olsson et al. (arXiv:2209.11895)',
        ...
        bias: {
          ...
          science: 'На основі Zou та ін. (2023) «Representation Engineering» та Bricken та ін. (2023) «Towards Monosemanticity». Замість вільної маніпуляції цей інструмент досліджує систематичні упередження. — Refs: Zou et al. (arXiv:2310.01405), Bricken et al. (transformer-circuits.pub/2023/monosemantic-features)',
  ...
  fr: {
    ...
    latentLab: {
      ...
      textLab: {
        ...
        explanationToggle: 'Afficher les fondements scientifiques',
        explainWhatTitle: 'Que montre cet outil ?',
        explainWhatText: 'Cet outil implémente trois approches de recherche actuelles pour l\'interprétabilité des LLM : l\'ingénierie de représentation (Zou et al. 2023) trouve des directions de concepts dans l\'espace d\'activation et manipule le comportement du modèle de manière ciblée. L\'archéologie comparative de modèles (Belinkov 2022, Olsson 2022) montre comment différents modèles représentent internement le même texte. L\'archéologie de biais (Zou 2023, Bricken 2023) révèle les biais systématiques par manipulation contrôlée de tokens. — Refs: Zou et al. (arXiv:2310.01405), Li et al. (arXiv:2306.03341), Belinkov (DOI:10.1162/coli_a_00422), Olsson et al. (arXiv:2209.11895), Bricken et al. (transformer-circuits.pub/2023/monosemantic-features)',
        explainHowTitle: 'Comment utiliser cet outil ?',
        explainHowText: 'Choisissez un préréglage de modèle dans le menu déroulant ci-dessus (par défaut : small / Llama 3.2 3B). Le modèle se charge automatiquement lorsque vous lancez une expérience. Trois onglets sont disponibles : Onglet 1 (RepEng) définit des paires de contraste et trouve des directions de concepts. Onglet 2 (Comparer) compare deux modèles et leurs représentations internes. Onglet 3 (Biais) exécute des expériences systématiques de biais.',
        modelPanel: {
        ...
        repeng: {
          ...
          guide: 'Cette expérience extrait une « direction de vérité » du modèle. Les paires de contraste pré-remplies contiennent chacune une déclaration vraie et une fausse. À partir des différences d\'activations, le système calcule une direction dans l\'espace de haute dimension. Lorsque cette direction est inversée (α = -1), le modèle devrait générer une mauvaise réponse pour un prompt factuel — même s\'il « connaît » la bonne. Cela révèle : le modèle encode non seulement des connaissances, mais aussi la tendance à répondre correctement vs. incorrectement.',
          languageHint: 'Recommandation : Les prompts en anglais fonctionnent significativement mieux car la plupart des LLM open source (LLaMA, Mistral) ont été principalement entraînés sur des données anglaises. Les exemples pré-remplis sont en anglais pour cette raison.',
          ...
          science: 'Basé sur Zou et al. (2023) « Representation Engineering » et Li et al. (2024) « Inference-Time Intervention ». Idée centrale : les LLM encodent des concepts abstraits (vérité, sentiment, éthique) comme des directions dans l\'espace d\'activation de haute dimension. Par des paires de contraste (phrase vraie vs. fausse), la direction encodant un concept peut être extraite. Ajouter cette direction au moment de l\'exécution modifie le comportement du modèle de manière ciblée — sans ré-entraînement. — Refs: Zou et al. (arXiv:2310.01405), Li et al. (arXiv:2306.03341)',
        ...
        compare: {
          ...
          science: 'Basé sur Belinkov (2022) « Probing Classifiers » et Olsson et al. (2022) « In-Context Learning and Induction Heads ». La heatmap montre le CKA (Centered Kernel Alignment) entre les couches des deux modèles. Une similarité élevée signifie : ces couches représentent l\'information de manière similaire. Les couches précoces (syntaxe) sont souvent similaires — les couches tardives (sémantique) divergent plus fortement, surtout avec des tailles de modèles différentes. — Refs: Belinkov (DOI:10.1162/coli_a_00422), Olsson et al. (arXiv:2209.11895)',
        ...
        bias: {
          ...
          science: 'Basé sur Zou et al. (2023) « Representation Engineering » et Bricken et al. (2023) « Towards Monosemanticity ». Au lieu de manipulation libre, cet outil étudie les biais systématiques : que se passe-t-il quand tous les pronoms masculins sont supprimés ? Quel genre le modèle choisit-il par défaut ? À quel point le texte change-t-il quand des mots positifs vs. négatifs sont amplifiés ? Les réponses révèlent quels biais sont encodés dans le modèle. — Refs: Zou et al. (arXiv:2310.01405), Bricken et al. (transformer-circuits.pub/2023/monosemantic-features)',
