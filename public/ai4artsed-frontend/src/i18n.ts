  ...
  fr: {
    ...
    latentLab: {
      ...
      textLab: {
        ...
        explainHowTitle: 'Comment utiliser cet outil ?',
        explainHowText: 'D\'abord, chargez un modèle via le panneau de modèles (petit pour des tests rapides, 3B+ pour des directions de concepts nettes). Trois onglets sont disponibles : Onglet 1 (RepEng) définit des paires de contraste et trouve des directions de concepts. Onglet 2 (Comparer) charge deux modèles et compare leurs représentations internes. Onglet 3 (Biais) exécute des expériences systématiques de biais.',
        modelPanel: {
